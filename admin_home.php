            ...
            <td style='text-align:center'>
             ...
             ";
               ...
               ";
                            ...
                            ?>
                            <!-------------------------------------------End Script for Fill with the product ----------------------------------------------------->
                                        ...
                                        <table border="1" style="border-color:gray ; width:810px ; text-align: center;">
                                            ...
                                            <tbody>
                                                ...
                                                while ($counter < count($order)) {
                                                    ...
                                                    echo "<td style='text-align:center'>".$order[$counter]['user_id']."</td>";
                                                    echo "<td style='text-align:center'>".$order[$counter]['address']."</td>";
                                                    echo "<td style='text-align:center'>".$order[$counter]['TotalPrice']."</td>";
